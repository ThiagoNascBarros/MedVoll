...
import org.med.voll.application.communication.request.patient.RequestUpdatePatientAddress;
...
public class Address {
    ...
    public void updatingInfo(RequestUpdatePatientAddress endereco) {
        if (endereco.logradouro() != null) {
            this.logradouro = endereco.logradouro();
        }
